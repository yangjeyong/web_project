	...
	<form name="register" method="post" action="proc/reg_proc.jsp">
		...
		<tr>
			<td colspan="2"><div align="right">
				<input type="button" value="메인으로" onclick="javascript:document.location='index.jsp'">
				<input type="button" value="가입신청" onclick="javascript:document.register.submit()">
			</div></td>
		</tr>
	</form>
</table>
